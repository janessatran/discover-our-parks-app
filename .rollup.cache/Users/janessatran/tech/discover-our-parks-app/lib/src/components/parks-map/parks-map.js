...
let ParksMap = class ParksMap extends MobxLitElement {
    constructor() {
        ...
        this.parks = [];
        this.ready = false;
        this.parkCodeToDataMap = new Map();
    ...
    async fetchWithTimeout(resource, options) {
        var _a;
        const timeout = (_a = options === null || options === void 0 ? void 0 : options.timeout) !== null && _a !== void 0 ? _a : 8000;
...
ParksMap.styles = [mainLayoutStyles, aboutSectionStyles, styles];
__decorate([
    state()
...
export { ParksMap };
//# sourceMappingURL=parks-map.js.map